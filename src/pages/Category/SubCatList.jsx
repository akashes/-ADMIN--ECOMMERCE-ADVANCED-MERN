...
const columns=[
  ...
  {id:'catName',label:'CATEGORY',minWidth:250},
  {id:'subCatName',label:'SUB CATEGORY',minWidth:400},
        ...
        <Table stickyHeader aria-label="sticky table">
          ...
          <TableBody>
            ...
            <TableRow >
              ...
              width={100}
              >
                <div className="flex items-center gap-4 w-[300px]"><div className="img w-[80px] h-auto rounded-md overflow-hidden group">
                  <Link to='/'>
                <img alt="" className="w-full group-hover:scale-105 transition-transform" src="https://res.cloudinary.com/dllelmzim/image/upload/v1752148661/electronics_w1qixi.png"/>
                 ...
                 <TableCell>
                <Chip label="Men" size="small" />
              </TableCell>
                 <TableCell>
                  <div className="flex items-center gap-3">

                  <Chip label="Shirt" size="small" color='primary' />
                  <Chip label="Shirt" size="small" color='primary' />
                  <Chip label="Shirt" size="small" color='primary' />
                  <Chip label="Shirt" size="small" color='primary' />
                  </div>
